The Side Project Sales Checklist is a comprehensive, chronologically ordered list of sales tactics that you can try with your next side project. The list is free and open source so feel free to [suggest your own additions anytime](https://github.com/karllhughes/side-project-sales/issues).
...
- [ ] Add potential leads to a Customer Relationship Manager (CRM) tool (see this list of side project CRMs).

### Sales Funnel Setup
- [ ] Set up interested leads email list and signup form (see this list of email marketing tools).
- [ ] Set up on-site messaging to capture leads and engage customers (see this list of live chat tools).
- [ ] Add call to action to company blog posts and social media accounts.
